...
라이브러리 입력(릴리즈64) : libboost_json-vc143-mt-x64-1_84.lib
라이브러리 입력(디버그64) : libboost_json-vc143-mt-gd-x64-1_84.lib
라이브러리 입력(릴리즈32) : libboost_json-vc143-mt-x32-1_84.lib
라이브러리 입력(디버그32) : libboost_json-vc143-mt-gd-x32-1_84.lib
*/
...
#else
#pragma comment(lib, "libboost_json-vc143-mt-x64-1_84.lib")
#endif
