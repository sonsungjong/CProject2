// WinApi12427ManualReset.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WinApi12427ManualReset.h"
...
const TCHAR* lpszEvent = _T("Event1");
HWND hMainWnd;
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINAPI12427MANUALRESET, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINAPI12427MANUALRESET));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINAPI12427MANUALRESET));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINAPI12427MANUALRESET);
